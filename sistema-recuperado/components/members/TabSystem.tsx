...
import { MemberAttachment, MemberComment } from '@/types/members';
...
const TabSystem: React.FC<TabSystemProps> = ({ lessonTitle, lessonDescription, comments, attachments }) => {
            ...
            <div className="animate-fade-in-up">
                ...
                {activeTab === 'description' && (
                    <div className="text-gray-600 dark:text-gray-300 leading-relaxed max-w-3xl">
                        <h3 className="text-2xl font-serif font-bold text-gray-900 dark:text-white mb-6">{lessonTitle}</h3>
                        <p className="mb-6 font-light text-lg">{lessonDescription}</p>
                        <p className="mb-8 font-light">
                            Nesta aula, você aprenderá os conceitos fundamentais para entender o módulo.
                            Preste atenção aos exemplos apresentados no vídeo.
                        </p>
                        <div className="p-6 bg-gray-50 dark:bg-[#18181b] border border-gray-200 dark:border-white/5 rounded-xl shadow-sm">
                            <h4 className="text-xs font-bold text-mozart-pink mb-4 uppercase tracking-widest">Pontos Principais</h4>
                            <ul className="list-disc list-inside space-y-3 text-sm text-gray-700 dark:text-gray-300">
                                <li>Entendendo os fundamentos</li>
                                <li>Implementando o padrão</li>
                                <li>Armadilhas comuns a evitar</li>
                            </ul>
                        </div>
                    </div>
                )}
                ...
                {activeTab === 'comments' && (
                    <div className="space-y-8 max-w-3xl">
                        ...
                        <div className="flex gap-5 mb-10">
                            <img src="https://api.dicebear.com/7.x/initials/svg?seed=Me" className="w-12 h-12 rounded-full border border-gray-200 dark:border-white/10" alt="me" />
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            {comment.isInstructor && (
                                                <span className="bg-mozart-pink/10 text-mozart-pink text-[10px] font-bold px-2 py-0.5 rounded uppercase tracking-wide">Instrutor</span>
                                            )}
